    ...
    std::unordered_map<std::string, ft::Tensor> output_tensors = std::unordered_map<std::string, ft::Tensor>{
        ...
        {"sequence_length",
         ...
         {"response_input_lengths",
          ft::Tensor{ft::MEMORY_GPU, ft::TYPE_INT32, std::vector<size_t>{request_batch_size, 1},
                    d_input_prompt_lengths_}}};
                                                ...
                                                const size_t max_request_output_len)
{
    ...
    d_input_prompt_lengths_ = (int*)(allocator_->reMalloc(d_input_prompt_lengths_,
        sizeof(int) * request_batch_size, false));
}

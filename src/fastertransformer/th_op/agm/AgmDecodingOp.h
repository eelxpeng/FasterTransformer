...
class IFTAgmDecoding {
public:
    virtual ~IFTAgmDecoding()                                                            = default;
    virtual std::vector<th::Tensor> forward(th::optional<int64_t>    beam_width_opt,
                                            ...
                                            th::optional<th::Tensor> forced_decoder_ids) = 0;
};

template<typename T>
class FTAgmDecoding: public IFTAgmDecoding {
public:
    FTAgmDecoding(int64_t                        head_num,
    ...
    std::vector<th::Tensor> forward(th::optional<int64_t>    beam_width_opt,
                                    ...
                                    th::optional<th::Tensor> no_repeat_ngram_size_opt,
                                    th::optional<th::Tensor> forced_decoder_ids_opt) override;
...
private:
    ...
    ft::AgmDecodingWeight<T> decoding_weights;

    ft::NcclParam tensor_para_;
    ft::NcclParam pipeline_para_;
};

class FasterTransformerAgmDecoding: public torch::jit::CustomClassHolder {
public:
    FasterTransformerAgmDecoding(int64_t              head_num,
                                 int64_t              size_per_head,
                                 int64_t              inter_size,
                                 int64_t              mem_d_model,
                                 int64_t              d_model,
...
private:
    ...
    torch_ext::IFTAgmDecoding* ftdecoding;

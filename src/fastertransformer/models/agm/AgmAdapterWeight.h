...
template<typename T>
struct AgmAdapterWeight {

    AgmAdapterWeight() = default;
    AgmAdapterWeight(size_t d_model, size_t tensor_para_size, size_t tensor_para_rank, size_t adapter_inter_size);
    ~AgmAdapterWeight();
    AgmAdapterWeight(const AgmAdapterWeight& other);
    AgmAdapterWeight& operator=(const AgmAdapterWeight& other);

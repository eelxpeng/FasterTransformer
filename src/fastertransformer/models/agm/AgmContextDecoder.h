...
template<typename T>
class AgmContextDecoder: public BaseLayer {
private:
    // buffer handling
...
public:
    AgmContextDecoder(size_t                              max_batch_size,
                      size_t                              head_num,
    ...
    AgmContextDecoder(AgmContextDecoder<T> const& decoder);

    ~AgmContextDecoder();

    void forward(TensorMap*                                    output_tensors,
                 const TensorMap*                              input_tensors,
                 const std::vector<AgmDecoderLayerWeight<T>*>* decoder_layer_weights);

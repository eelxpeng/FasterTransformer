...
template<typename T>
struct AgmDecodingWeight {

    AgmDecodingWeight() = default;
    AgmDecodingWeight(size_t                head_num,
    ...
    ~AgmDecodingWeight();
    AgmDecodingWeight(const AgmDecodingWeight& other);
    AgmDecodingWeight& operator=(const AgmDecodingWeight& other);

    std::vector<AgmDecoderLayerWeight<T>*> decoder_layer_weights;
    ...
    void setAgmStructureDiff(bool                  agm_with_bias_para,
